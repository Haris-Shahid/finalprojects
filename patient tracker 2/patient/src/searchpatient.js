...
import { View ,Text, Button, StyleSheet, TextInput, TouchableHighlight ,Dimensions ,ListView } from 'react-native';
    ...
    constructor(){
       ...
       adddata(){
        ...
        dbRef.on('child_added', snap => {
            ...
            console.log(details)
            var details= details.filter((details)=> this.search(details))
            this.setState({
                      details,
                      datasource:this.ds.cloneWithRows(details)  
            })
